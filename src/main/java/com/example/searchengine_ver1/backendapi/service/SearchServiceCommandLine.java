...
import java.util.*;
/// For Command line verification uncomment run method and implement CommandLineRunner
/**
 * Class currently deprecated
 * */
@Service
public class SearchServiceCommandLine {
    ...
    @Autowired
    public SearchServiceCommandLine(FileIndexRepository fileIndexRepository,SuggestQuerySubject suggestQuerySubject,HistoryTracker historyTracker,PopularQueryTracker popularQueryTracker,PopularFilesTracker popularFilesTracker,RankFilesSubject rankFilesSubject,FileIndexer fileIndexer){
